...
import com.shuoxd.bluetext.datalogConfig.BlueToothMode.BleModuleAdvanceActivity;
...
public class BleModuleConfigActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_setwifi_guide:
                Intent intent = new Intent(this, BleModuleAdvanceActivity.class);
        ...
        if (wifiWindow == null) {
            wifiWindow = new CommonPopupWindow(this, R.layout.popuwindow_comment_list_layout, dropView.getWidth(), LinearLayout.LayoutParams.WRAP_CONTENT) {
                ...
                protected void initView() {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(BleModuleConfigActivity.this, LinearLayoutManager.VERTICAL, false));
        ...
        if (isView) {
            CircleDialogUtils.showCommentDialog(this, getString(R.string.温馨提示),
                    ...
                    getString(R.string.mCancel_ios), Gravity.CENTER, v -> {
                        BleSession.getInstance().writeCharacteristic(datavalues);
                    }, null, null);
        }
...
/*********************发送命令设置数据***************************/
    ...
    private void connectSendMsg() {
        // BleSession already connected from scan page
