package com.growatt.protocal.version6;



import com.growatt.protocal.modbus.Modbus;
import com.growatt.protocal.modbus.ModbusRead;
...
public class Protocol0X17 extends Protocol {
     ...
     * 读取一个寄存器值
     */
    public static Protocol0X17 newInstanceFor0X03(int registerAddress) throws Exception {
     ...
     * 读取一个寄存器值
     */
    public static Protocol0X17 newInstanceFor0X04(int registerAddress) throws Exception {
     ...
     * 读取多个连续地址寄存器的值
     */
    public static Protocol0X17 newInstanceFor0X03(int registerAddress, int count) throws Exception {
     ...
     * 读取多个连续地址寄存器的值
     */
    public static Protocol0X17 newInstanceFor0X04(int registerAddress, int count) throws Exception {
     ...
     * @param count                数据读取个数
     */
    private static Protocol0X17 newInstanceForRead(int functionCode, int startRegisterAddress, int count) throws Exception {
     ...
     */
    public static Protocol0X17 newInstanceForSet(int startRegisterAddress, byte[] _setValues) throws Exception {
    ...
    private static Protocol0X17 newInstance(byte[] _modbusData) throws Exception {
      ...
      /*  if (length % 16 == 0) {
        ...
        protocol._dataAreaWithAES = AESCBCUtil.AESEncryption(protocol._dataArea);
     ...
     */
    public static List<byte[]> getValues(byte[] rawResponse) throws Exception {
     ...
     */
    public static byte[] getModbusData(byte[] rawResponse) throws Exception {
    ...
    public static boolean isSetSuccess(byte[] rawResponse) throws Exception {
